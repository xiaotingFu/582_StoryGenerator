...
export default class Story extends React.Component {
  ...
  parseText(text) {
    ...
    let result = text.replace(regexStart, function(x){return (parseColor(x));})
      .replace(regexEnd, function(x){return "</strong></span>";});
    console.log(result);
    return result;
  }
  ...
  downloadTxtFile = () => {
    ...
    const file = new Blob([this.state.editorState.toHTML().replace(/<(.|\n)*?>/g, '')], {type: 'text/plain'});
